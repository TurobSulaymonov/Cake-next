...
const PopularPropertyCard = (props: PopularPropertyCardProps) => {
  ...
  if (device === 'mobile') {
    return (  // Make sure to use return here
      <Stack className="popular-card-box">
        <div className="fz-3-single-product__img">
          ...
          <div className="fz-3-single-product__actions">
            ...
            <div className="bottom-actions">
              <Button variant="outlined" className="fz-3-add-to-cart">
                Add to cart
              </Button>
              <Button variant="outlined" className="fz-3-quick-view">
        ...
        <div className="fz-3-single-product__txt">
          <Link href={`/shop/detail}`} className="fz-3-single-product__title">
